...
package com.fightjudge.simulator;
...
public class SampleRunner {
    ...
    static class TestProducer {
        ...
        private String[] randomWords = new String[]{"hand", "leg", "throw", "baz", "fox"};
        private Random random = new Random();

        @Bean
        @InboundChannelAdapter(channel = TestSource.OUTPUT, poller = @Poller(fixedDelay = "5000"))
